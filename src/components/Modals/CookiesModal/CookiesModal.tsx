        ...
        <div className={styles.wrapper}>
            <div className={styles.container}>
                <div className={styles.flexHeader}>
                    ...
                    <p className={styles.text}>Este site utiliza cookies para melhorar sua experiência. Ao clicar em &quot;Aceitar&quot;, você concorda com os nossos <DefaultLink href='/policies/terms-of-use' target="_blank" rel="noopener noreferrer">Termos de Uso</DefaultLink> e <DefaultLink href='/policies/privacy-policy' target="_blank" rel="noopener noreferrer">Política de Privacidade</DefaultLink>.</p>
                </div>
